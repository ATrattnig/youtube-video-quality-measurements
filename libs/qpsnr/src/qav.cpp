...
int qav::qvideo::get_fps_k(void) const {
    ...
    if (pFormatCtx->streams[videoStream]->time_base.num != 0)
        return 1000*pFormatCtx->streams[videoStream]->time_base.den/pFormatCtx->streams[videoStream]->time_base.num;
